  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/usuarios') }}">Administración de candidatos</a></li>
        <li class="breadcrumb-item active">Detalle candidato</li>
      ...
      @include('admin.candidates.includes.profile')

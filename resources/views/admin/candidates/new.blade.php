  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('admin/candidatos') }}">Administración de candidatos</a></li>
        <li class="breadcrumb-item active">Crear candidato</li>
      ...
      @include('admin.candidates.includes.create')

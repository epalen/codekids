          ...
          <div class="card-header col-lg-12">
            <div class="col-lg-3">
              <a>
                ...
                &nbsp; Transacciones de campañas
              </a>
            </div>                      
            <div class="card-actions col-lg-3">
              {!! Form::open(['route' => 'donaciones.campanas.index', 'method' => 'GET']) !!}
            ...
            <table class="table table-responsive-sm table-striped table-sm">
              <thead>
                <tr>
                  ...
                  <th style="width: 20%">Nombre de campaña</th>                  
                ...
                @foreach ($data as $key => $donations)
                  <tr>
                    ...
                    <td style="width: 20%" align="center">
                      <a class="btn btn-info btn-sm" href="{{ route('donaciones.campanas.show',$donations->id) }}" data-toggle="tooltip" rel="tooltip" data-placement="top" title="Detalle de la campaña"> 
                        <i class="icon-info"></i> 
                      </a>
                    </td>
                  </tr>

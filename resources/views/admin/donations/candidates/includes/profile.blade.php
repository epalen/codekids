            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="text-justify">
                  <img src="{{ URL::asset('uploads/candidates/' . $transactions->candidate->avatar) }}" class="avatar-lg img-circle img-thumbnail" alt="avatar">                            
                </div>
              </div>
              <!-- right column -->
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  {{ $transactions->candidate->name }} {{ $transactions->candidate->last_name }}
                </div>
                <div class="form-group">
              ...
              <div class="col-sm-12">
                <div class="form-group" align="center">
                  <a class="btn btn-warning" href="{{ route('donaciones.candidatos.index') }}" data-toggle="tooltip" rel="tooltip" data-placement="top" title="Retornar">

...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('admin/publicacion') }}">Administración de publicaciones</a></li>
      ...
      @include('admin.posts.includes.update')
  ...
  <script>
      $(document).ready(function() {
          $('#technig').summernote({
              height:200,
              placeholder: 'Colocar contenido de publicación aquí...',

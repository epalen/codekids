      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <i class="fa fa-edit"></i>Crear publicación
          </div>
          <div class="card-body">
            @if (count($errors) > 0)
            ...
            {!! Form::open(array('route' => 'publicacion.store','method' => 'POST', 'enctype' => 'multipart/form-data')) !!}
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    {!! Form::select('category_id', $categories, null, ['class' => 'form-control', 'placeholder' => 'Seleccionar una categoría']) !!}
                </div>

                <div class="col-sm-12">   
                  <div class="form-group">                 
                    {{Form::textarea('content',null,array('class' => 'form-control', 'placeholder'=>'Content', 'size' => '30x4', 'id' => 'summernote'))}}
                  </div>
                  <div class="form-group">
